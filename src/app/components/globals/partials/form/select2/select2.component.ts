import { AfterViewInit, Component, Input, Output, EventEmitter, ViewChild, Renderer, SimpleChanges } from '@angular/core';
...
export class Select2Component implements AfterViewInit {
    ...
    ngAfterViewInit() {
        this.renderer.listen(
            this.searchInput.nativeElement, 'keyup', (_event) => {
